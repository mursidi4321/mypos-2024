      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('_assets') ?>/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="<?= base_url('_assets') ?>/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li><a href="<?= base_url('_assets') ?>/documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
